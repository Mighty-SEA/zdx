        ...
        View::composer('*', function ($view) {
            ...
            $companyInfo = Cache::remember('company_info', 3600, function () {
                ...
                $settings = [
                    ...
                    'company_phone_cs1' => Setting::getValue('company_phone_cs1', ''),
                    'company_phone_cs2' => Setting::getValue('company_phone_cs2', ''),
                    'cs_name1' => Setting::getValue('cs_name1', 'Customer Service 1'),
                    'cs_name2' => Setting::getValue('cs_name2', 'Customer Service 2'),
                    ...
                    'contact_phone_cs1' => Setting::getValue('company_phone_cs1', '0858 1471 8889'),
                    'contact_phone_cs2' => Setting::getValue('company_phone_cs2', '0858 1471 8890'),
