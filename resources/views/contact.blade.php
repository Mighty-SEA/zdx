...
@section('meta_tags')
    ...
    $whatsappPhone2 = preg_replace('/[^0-9]/', '', $companyInfo->company_phone2 ?? '');
    
    // Get formatted phone for display
    $displayPhone = formatPhoneNumber($companyInfo->company_phone ?? '');
    $displayPhone2 = formatPhoneNumber($companyInfo->company_phone2 ?? '');
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 border-t-4 border-[#FF6000] transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                ...
                <div class="space-y-3">
                    ...
                    <p class="text-[#FF6000] text-center text-xl font-bold">{{ $displayPhone2 }}</p>
                </div>
                <div class="mt-6 text-center">
                    <a href="tel:{{ $whatsappPhone }}" class="inline-flex items-center px-4 py-2 bg-[#FF6000] text-white rounded-lg hover:bg-[#E65100] transition-colors">
