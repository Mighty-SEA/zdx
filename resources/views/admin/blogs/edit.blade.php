                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-4 pt-3 border-t border-gray-200">
                                ...
                                <div class="p-3 bg-white rounded border border-gray-300">
                                    <h5 id="seo-preview-title" class="text-blue-600 font-medium">{{ $blog->title }} - ZDX Cargo</h5>
                                    <div class="text-green-600 text-xs mt-1">{{ url('/') }}/<span id="seo-preview-slug">{{ $blog->slug }}</span></div>
                                    <p id="seo-preview-desc" class="text-gray-600 text-sm mt-1">{{ $blog->description }}</p>
