    ...
    <div class="mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Ubah informasi layanan Anda</p>
            </div>
        ...
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="3" 
                        class="w-full rounded-md border-2 border-gray-300 focus:border-[#FF6000] focus:ring focus:ring-[#FF6000] focus:ring-opacity-20 shadow-sm transition-all" 
                        placeholder="Masukkan deskripsi singkat tentang layanan ini..." required>{{ old('description', $service->description) }}</textarea>
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="content" id="content" rows="10" class="w-full rounded-md border-2 border-gray-300 focus:border-[#FF6000] focus:ring focus:ring-[#FF6000] focus:ring-opacity-20 shadow-sm transition-all">{{ old('content', $service->content) }}</textarea>
                    @error('content')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md relative" id="dropzone-upload">
                            <div class="space-y-1 text-center">
                                ...
                                <div id="upload-prompt" class="{{ $service->image ? 'hidden' : '' }}">
